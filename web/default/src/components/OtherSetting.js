...
const OtherSetting = () => {
  ...
  const openGitHubRelease = () => {
    window.location = 'https://github.com/geoshan/asterisk-token-router/releases/latest';
  };

  const checkUpdate = async () => {
    const res = await API.get(
      'https://api.github.com/repos/geoshan/asterisk-token-router/releases/latest'
    );
            ...
            <Form.Input
              label={
                <label>
                  ...
                  <Link to='https://github.com/geoshan/asterisk-token-router/blob/main/web/README.md'>
