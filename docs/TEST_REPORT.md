...
| 项目 | 详情 |
|------|------|
| **端点** | POST /v1/chat/completions (qwen-max) |
| **并发** | 10 |
| **请求数** | 200 |
| **P50 延迟** | 570 ms |
| **P99 延迟** | 5.3 s |
| **网关开销** | < 1 ms (DNS+write+read) |
| **说明** | 总延迟以上游模型响应为主，网关路由/鉴权开销 < 1ms |
...
| **并发** | 50 |
| **请求数** | 400 |
| **吞吐量** | 64.5 req/s（受限于上游速率） |
| **P50** | 542 ms |
| **429 错误** | 104/400 (26%) — 上游 Qwen-Max 限流 |
| **网关侧** | 零内部错误，428/400 成功代理 |
